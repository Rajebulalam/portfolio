        ...
        <section id='services' className='py-10 bg-neutral'>
            <div className='w-full sm:w-11/12 mx-auto px-4 sm:px-6 services'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4'>
                    <div data-aos="fade-down" data-aos-duration="1000" className='service-hover'>
                    ...
                    <div data-aos="fade-down" data-aos-duration="1500" className='service-hover'>
                        <div className='text-center'>
                    ...
                    <div data-aos="fade-down" data-aos-duration="2000" className='service-hover'>
                        <div className='text-center'>
                            <FontAwesomeIcon className='font-awesome text-primary service-font border-4 rounded-full text-2xl p-6' icon={faObjectGroup}></FontAwesomeIcon>
                        </div>
                    ...
                    <div data-aos="fade-down" data-aos-duration="2500" className='service-hover'>
                        <div className='text-center'>
