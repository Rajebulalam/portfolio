        ...
        <section className='py-10'>
            <div className='w-full sm:w-11/12 mx-auto px-4 sm:px-6'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 p-6 bg-gray-200 mb-6'>
                    <img className='rounded-sm h-[380px]' src={exists?.main} alt="mainImage" />
                    <img className='rounded-sm h-[380px]' src={exists?.second} alt="mainImage" />
                    <img className='rounded-sm h-[380px]' src={exists?.third} alt="mainImage" />
                </div>
